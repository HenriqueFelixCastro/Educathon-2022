...
var ButtonCTA = function ButtonCTA(_ref) {
  ...
  return type.includes('video') ? /*#__PURE__*/_react.default.createElement("div", null, _CTALogic.default.launchLightBox(renderLightBox, openLightBox, mediaData), !renderLightBox && /*#__PURE__*/_react.default.createElement(_ButtonGroup.ButtonGroup, {
  ...
  })) : /*#__PURE__*/_react.default.createElement(_ButtonGroup.ButtonGroup, {
  ...
  return buttons.map(function (button, key) {
    if (button.type === 'video') {
      ...
      button.copy = !title[0] ? button.copy : formatCTAcopy({
        title: (button === null || button === void 0 ? void 0 : button.media.title) || title[0].title,
        duration: title[0].duration
      });
      button.href = '#';
    } else {
      button.onClick = button.onClick || function (e) {
