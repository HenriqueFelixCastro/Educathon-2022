  ...
  if (type === 'video') {
    ...
    if (!disableImage) {
      ...
      image = cardProps.image ? cardProps.image : {
        defaultSrc: _KalturaPlayer.default.getThumbnailUrl({
          mediaId: (_cardProps$media = cardProps.media) === null || _cardProps$media === void 0 ? void 0 : _cardProps$media.src,
          width: thumbnailSize
        }),
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, _CTALogic.default.launchLightBox(renderLightBox, openLightBox, otherProps.media), !renderLightBox && /*#__PURE__*/_react.default.createElement(_CardLink.CardLink, {
      customClassName: "".concat(prefix, "--card__CardCTA ").concat(prefix, "--card__video"),
      card: _objectSpread(_objectSpread({}, cardProps), {}, {
        cta: {
          href: '#',
          icon: {
    ...
    return /*#__PURE__*/_react.default.createElement(_CardLink.CardLink, {
      customClassName: "".concat(prefix, "--card__CardCTA"),
      card: _objectSpread(_objectSpread({}, cardProps), {}, {
        cta: {
          type: type,
