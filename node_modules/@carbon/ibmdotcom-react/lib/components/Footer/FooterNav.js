...
var FooterNav = function FooterNav(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("nav", {
    ...
    className: (0, _classnames.default)("".concat(prefix, "--footer-nav"), (0, _defineProperty2.default)({}, "".concat(prefix, "--footer-nav__locale-button--disabled"), disableLocaleButton))
...
function renderGroups(groups) {
  return groups.map(function (_ref2, index) {
    var title = _ref2.title,
        links = _ref2.links;
    return /*#__PURE__*/_react.default.createElement(_FooterNavGroup.default, {
      title: title,
      links: links,
      key: index
    });
