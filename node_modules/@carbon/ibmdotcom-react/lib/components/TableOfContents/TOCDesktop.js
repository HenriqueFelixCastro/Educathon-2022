...
var TOCDesktop = function TOCDesktop(_ref) {
  ...
  var renderMenuItems = function renderMenuItems(items, activeId) {
    return items.map(function (item, index) {
      if ((item === null || item === void 0 ? void 0 : item.id) !== 'menuLabel') {
        ...
        }, /*#__PURE__*/_react.default.createElement("a", (0, _extends2.default)({}, isActive ? {
  ...
  var handleOnClick = function handleOnClick(e, id) {
    ...
    (0, _smoothScroll.default)(null, selector, masthead === null || masthead === void 0 ? void 0 : masthead.offsetHeight);
  ...
  }, /*#__PURE__*/_react.default.createElement("ul", null, renderMenuItems(menuItems, selectedId)));
};
