...
var _altlangs = _interopRequireDefault(require("../../internal/vendor/@carbon/ibmdotcom-utilities/utilities/altlangs/altlangs"));
...
var LocaleModal = function LocaleModal(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_ComposedModal.default, {
  ...
  }, isFiltering ? /*#__PURE__*/_react.default.createElement(_ComposedModal.ModalHeader, {
    "data-autoid": "".concat(stablePrefix, "--locale-modal__region-back"),
    label: [/*#__PURE__*/_react.default.createElement(_LinkWithIcon.LinkWithIcon, {
      href: "#",
      iconPlacement: 'left'
    }, /*#__PURE__*/_react.default.createElement("span", null, modalLabels.headerTitle), /*#__PURE__*/_react.default.createElement(_.default, {
    ...
    label: [langDisplay, /*#__PURE__*/_react.default.createElement(_2.default, {
      key: "earthfilled",
      className: "".concat(prefix, "--locale-modal__label-globe")
    })],
    title: modalLabels.headerTitle,
    iconDescription: modalLabels.modalClose
  }), /*#__PURE__*/_react.default.createElement(_ComposedModal.ModalBody, {
    className: "".concat(prefix, "--locale-modal ").concat(filterClass)
  }, /*#__PURE__*/_react.default.createElement(_LocaleModalRegions.default, {
  ...
  }), /*#__PURE__*/_react.default.createElement(_LocaleModalCountries.default, (0, _extends2.default)({
    regionList: sortList(list),
    setClearResults: setClearResults,
