...
var _ConditionalWrapper = _interopRequireDefault(require("../../internal/components/ConditionalWrapper/ConditionalWrapper"));

var _classnames = _interopRequireDefault(require("classnames"));

var _MastheadLogo = _interopRequireDefault(require("../../internal/vendor/@carbon/ibmdotcom-services/services/MastheadLogo/MastheadLogo"));
...
var _TooltipDefinition = _interopRequireDefault(require("../../internal/vendor/carbon-components-react/components/TooltipDefinition"));
...
var IbmLogo = function IbmLogo(_ref) {
  ...
  var useAlternateLogo = _MastheadLogo.default.setMastheadLogo(logoData);

  var logoClasses = (0, _classnames.default)((_cx = {}, (0, _defineProperty2.default)(_cx, "".concat(prefix, "--header__logo"), true), (0, _defineProperty2.default)(_cx, "".concat(prefix, "--search-active"), isSearchActive), _cx));
  return /*#__PURE__*/_react.default.createElement("div", {
    className: logoClasses
  }, /*#__PURE__*/_react.default.createElement(_ConditionalWrapper.default, {
    condition: logoData && logoData.tooltip !== undefined,
    wrapper: function wrapper(children) {
      return /*#__PURE__*/_react.default.createElement(_TooltipDefinition.default, {
        tooltipText: logoData.tooltip
      }, children);
    }
  }, useAlternateLogo ? /*#__PURE__*/_react.default.createElement("a", {
    // eslint-disable-line
    "aria-label": "IBM\xAE",
    "data-autoid": autoid,
  ...
  }, !useAlternateLogo && /*#__PURE__*/_react.default.createElement(MastheadLogo, null))));
};
...
IbmLogo.propTypes = {
   ...
   * for details.
   */
  logoData: _propTypes.default.shape({
    svg: _propTypes.default.string,
    tooltip: _propTypes.default.string,
    denyList: _propTypes.default.array,
    allowList: _propTypes.default.array,
    expire: _propTypes.default.string,
