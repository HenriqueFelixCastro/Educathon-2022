...
var _LightboxMediaViewer = _interopRequireDefault(require("../LightboxMediaViewer/LightboxMediaViewer"));
...
var VideoPlayer = function VideoPlayer(_ref) {
  ...
  var videoDuration = _KalturaPlayer.default.getMediaDuration(videoData.msDuration, true);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _KalturaPlayer.default.embedMedia(videoId, "".concat(prefix, "--").concat(videoPlayerId));
  ...
  var renderInLightbox = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: "".concat(prefix, "--video-player__video")
  }, /*#__PURE__*/_react.default.createElement(_VideoImageOverlay.default, {
    videoId: videoId,
    videoData: videoData,
    ...
    thumbnail: thumbnail
  })), /*#__PURE__*/_react.default.createElement(_LightboxMediaViewer.default, {
    open: embedVideo,
    media: {
      type: 'video',
      src: videoId
  ...
  var renderInline = /*#__PURE__*/_react.default.createElement("div", {
    className: "".concat(prefix, "--video-player__video"),
    id: "".concat(prefix, "--").concat(videoPlayerId)
  }, !autoPlay && /*#__PURE__*/_react.default.createElement(_VideoImageOverlay.default, {
    videoId: videoId,
    videoData: videoData,
    embedVideo: setEmbedVideo,
    playingMode: playingMode,
  ...
  }, playingMode === 'lightbox' ? renderInLightbox : renderInline), showCaption && /*#__PURE__*/_react.default.createElement("div", {
