...
var _escaperegexp = _interopRequireDefault(require("../../internal/vendor/@carbon/ibmdotcom-utilities/utilities/escaperegexp/escaperegexp"));
...
var _SearchTypeahead = _interopRequireDefault(require("../../internal/vendor/@carbon/ibmdotcom-services/services/SearchTypeahead/SearchTypeahead"));
...
var MastheadSearch = (0, _react.forwardRef)(function (_ref, searchIconButton) {
  var _cx;
  ...
  var placeHolderText = _ref.placeHolderText,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["placeHolderText", "initialSearchTerm", "renderValue", "searchOpenOnload", "navType", "isSearchActive", "onChangeSearchActive"]);
  ...
  var _useState = (0, _react.useState)(searchOpenOnload),
  ...
  var handleChangeSearchActive = (0, _react.useCallback)(function (event) {
  ...
  var className = (0, _classnames.default)((_cx = {}, (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search"), true), (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search--active"), isSearchActive), _cx));
  /**
  ...
  function renderInputComponent(componentInputProps) {
    return /*#__PURE__*/_react.default.createElement(_MastheadSearchInput.default, {
  ...
  function renderSuggestion(suggestion, _ref5) {
    ...
    return /*#__PURE__*/_react.default.createElement(_MastheadSearchSuggestion.default, {
      suggestion: suggestion,
      query: query,
  ...
  function renderSectionTitle(section) {
    return section.items.length > 0 && section.title ? /*#__PURE__*/_react.default.createElement("span", null, section.title) : null;
  }
  /**
  ...
  function getValueFromQueryString() {
    try {
      return new URLSearchParams(_windowOrGlobal.default.location.search).get('q');
    } catch (e) {
      return '';
    }
  }
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: className,
    ref: ref
  }, isSearchActive && /*#__PURE__*/_react.default.createElement("form", {
    ...
    name: "lnk",
    value: "mhsrch"
  }), /*#__PURE__*/_react.default.createElement(_reactAutosuggest.default, (0, _extends2.default)({
  ...
  }, /*#__PURE__*/_react.default.createElement(_HeaderGlobalAction.default, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_2.default, null)), /*#__PURE__*/_react.default.createElement(_HeaderGlobalAction.default, {
...
MastheadSearch.propTypes = {
   ...
   */
  isSearchActive: _propTypes.default.bool,

  /**
   * Hook to toggle active state back to <Masthead />
   */
  onChangeSearchActive: _propTypes.default.func,
