...
var CategoryGroup = function CategoryGroup(_ref) {
  ...
  }, href ? /*#__PURE__*/_react.default.createElement(_LinkWithIcon.default, {
    href: href,
    className: "".concat(prefix, "--masthead__megamenu__category-headline"),
    "data-autoid": "".concat(rest.autoid, "-list").concat(rest.index)
  }, /*#__PURE__*/_react.default.createElement("span", null, title), /*#__PURE__*/_react.default.createElement(_.default, null)) : /*#__PURE__*/_react.default.createElement("div", {
    className: "".concat(prefix, "--masthead__megamenu__category-headline"),
    "data-autoid": "".concat(rest.autoid, "-list").concat(rest.index)
  }, /*#__PURE__*/_react.default.createElement("p", null, title)), children)));
};
