...
var ContentItem = function ContentItem(_ref) {
  ...
  }, heading), _renderMedia(mediaType, mediaData, inverse), copy && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), cta && /*#__PURE__*/_react.default.createElement(_CTA.CTA, (0, _extends2.default)({}, cta, {
...
var _renderMedia = function _renderMedia(type, data, inverse) {
  if (data) {
    ...
    }, type === 'image' && /*#__PURE__*/_react.default.createElement(_ImageWithCaption.ImageWithCaption, (0, _extends2.default)({
      inverse: inverse
    }, data)), type === 'video' && /*#__PURE__*/_react.default.createElement(_VideoPlayer.VideoPlayer, (0, _extends2.default)({
      inverse: inverse
    }, data)));
  }
};
...
ContentItem.propTypes = {
  ...
  cta: _propTypes.default.shape({
    style: _propTypes.default.oneOf(['text', 'button']),
