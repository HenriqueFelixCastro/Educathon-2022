...
var HeaderMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function HeaderMenu(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleOnClick", function (event) {
      ...
      var elems = (_root$document = _windowOrGlobal.default.document) === null || _root$document === void 0 ? void 0 : _root$document.querySelectorAll(".".concat(prefix, "--masthead__l0, body"));
      ...
      _this.setState(function (prevState) {
        if (_this.props.disableScroll) {
          if (prevState.expanded) {
            ...
            (_root$document3 = _windowOrGlobal.default.document) === null || _root$document3 === void 0 ? void 0 : (_root$document3$body = _root$document3.body) === null || _root$document3$body === void 0 ? void 0 : _root$document3$body.classList.add("".concat(prefix, "--body__lock-scroll"));
            elems.forEach(function (elem) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleOnBlur", function (event) {
      ...
      var elems = (_root$document4 = _windowOrGlobal.default.document) === null || _root$document4 === void 0 ? void 0 : _root$document4.querySelectorAll(".".concat(prefix, "--masthead__l0, body"));
      ...
      if (!event.currentTarget.contains(event.relatedTarget)) {
        ...
        if (_this.props.disableScroll) {
          ...
          (_root$document5 = _windowOrGlobal.default.document) === null || _root$document5 === void 0 ? void 0 : (_root$document5$body = _root$document5.body) === null || _root$document5$body === void 0 ? void 0 : _root$document5$body.classList.remove("".concat(prefix, "--body__lock-scroll"));
          elems.forEach(function (elem) {
            return elem.style.marginRight = '0px';
          });
        }
    ...
    _this.items = [];
    _this.scrollBarWidth = ((_root$window = _windowOrGlobal.default.window) === null || _root$window === void 0 ? void 0 : _root$window.innerWidth) - ((_root$document6 = _windowOrGlobal.default.document) === null || _root$document6 === void 0 ? void 0 : _root$document6.body.offsetWidth);
  ...
  (0, _createClass2.default)(HeaderMenu, [{
    ...
    value: function render() {
      ...
      }, accessibilityLabel), menuLinkName, /*#__PURE__*/_react.default.createElement(MenuContent, null)), /*#__PURE__*/_react.default.createElement("ul", (0, _extends2.default)({}, accessibilityLabel, {
