...
var _ContentBlock = _interopRequireDefault(require("../ContentBlock/ContentBlock"));
...
var _renderMedia = function _renderMedia(type, data) {
  if (data) {
    ...
    }, type === 'image' && /*#__PURE__*/_react.default.createElement(_ImageWithCaption.ImageWithCaption, data), type === 'video' && /*#__PURE__*/_react.default.createElement(_VideoPlayer.VideoPlayer, data));
  }
};
/**
...
var LeadSpaceBlock = function LeadSpaceBlock(_ref) {
  ...
  var pageTitle = /*#__PURE__*/_react.default.createElement("div", null, title && /*#__PURE__*/_react.default.createElement("h1", {
  ...
  }, pageTitle, /*#__PURE__*/_react.default.createElement(_ContentBlock.default, {
    heading: heading,
    copy: copy
  }, _renderMedia(mediaType, mediaData), /*#__PURE__*/_react.default.createElement(_LinkList.LinkList, {
    style: "vertical-end",
    heading: items.heading,
    items: items.items
  }), /*#__PURE__*/_react.default.createElement(_CTA.CTA, (0, _extends2.default)({
    customClassName: "".concat(prefix, "--leadspace-block__cta ").concat(prefix, "--leadspace-block__cta-col")
  }, cta))), /*#__PURE__*/_react.default.createElement(_HorizontalRule.HorizontalRule, null));
};
