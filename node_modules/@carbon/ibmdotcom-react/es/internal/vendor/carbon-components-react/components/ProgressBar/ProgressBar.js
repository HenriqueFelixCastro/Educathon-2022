...
function ProgressBar(_ref) {
  ...
  var wrapperClasses = classNames("".concat(prefix, "--progress-bar"), "".concat(prefix, "--progress-bar--").concat(size), _defineProperty({}, "".concat(prefix, "--progress-bar--indeterminate"), indeterminate), className);
