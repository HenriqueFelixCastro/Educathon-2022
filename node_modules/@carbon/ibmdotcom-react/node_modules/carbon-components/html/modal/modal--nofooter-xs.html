...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vbv2zo4knde">Show
  modal</button>

<div data-modal id="modal-vbv2zo4knde" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vbv2zo4knde-label" aria-describedby="modal-vbv2zo4knde-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vbv2zo4knde-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vbv2zo4knde-heading">Modal heading</p>
