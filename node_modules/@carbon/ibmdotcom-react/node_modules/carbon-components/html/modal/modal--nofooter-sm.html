...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-whiwka0o6zn">Show
  modal</button>

<div data-modal id="modal-whiwka0o6zn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-whiwka0o6zn-label" aria-describedby="modal-whiwka0o6zn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-whiwka0o6zn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-whiwka0o6zn-heading">Modal heading</p>
