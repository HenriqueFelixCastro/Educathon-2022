...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kic6vah50v">Show
  modal</button>

<div data-modal id="modal-kic6vah50v" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kic6vah50v-label" aria-describedby="modal-kic6vah50v-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kic6vah50v-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kic6vah50v-heading">Modal heading</p>
