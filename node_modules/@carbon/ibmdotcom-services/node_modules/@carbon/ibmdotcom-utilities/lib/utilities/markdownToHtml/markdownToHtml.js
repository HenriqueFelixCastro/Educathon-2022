...
function markdownToHtml(str) {
  ...
  if (customTags) {
    _isomorphicDompurify.default.addHook('uponSanitizeElement', function (node, _ref2) {
  ...
  var convertedMarkdown = _isomorphicDompurify.default.sanitize((0, _marked.marked)(converted));

  if (customTags) {
    _isomorphicDompurify.default.removeHook('uponSanitizeElement');
  }
