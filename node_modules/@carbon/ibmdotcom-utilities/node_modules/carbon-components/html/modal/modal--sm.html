...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-vjrp9ld5ozj">Show
  modal</button>

<div data-modal id="modal-vjrp9ld5ozj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-vjrp9ld5ozj-label" aria-describedby="modal-vjrp9ld5ozj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-vjrp9ld5ozj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-vjrp9ld5ozj-heading">Modal heading</p>
