...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mx60w0ygyn">Show
  modal</button>

<div data-modal id="modal-mx60w0ygyn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mx60w0ygyn-label" aria-describedby="modal-mx60w0ygyn-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mx60w0ygyn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mx60w0ygyn-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
