...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-j1qe9u20h7">Show
  modal</button>

<div data-modal id="modal-j1qe9u20h7" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-j1qe9u20h7-label" aria-describedby="modal-j1qe9u20h7-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-j1qe9u20h7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-j1qe9u20h7-heading">Modal heading</p>
