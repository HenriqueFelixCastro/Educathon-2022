...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0n3zwi47iwtp">Show
  modal</button>

<div data-modal id="modal-0n3zwi47iwtp" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0n3zwi47iwtp-label" aria-describedby="modal-0n3zwi47iwtp-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0n3zwi47iwtp-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0n3zwi47iwtp-heading">Modal heading</p>
