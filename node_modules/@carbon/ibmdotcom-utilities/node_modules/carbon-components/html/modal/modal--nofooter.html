...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2x3y8csuv5o">Show
  modal</button>

<div data-modal id="modal-2x3y8csuv5o" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2x3y8csuv5o-label" aria-describedby="modal-2x3y8csuv5o-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2x3y8csuv5o-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2x3y8csuv5o-heading">Modal heading</p>
