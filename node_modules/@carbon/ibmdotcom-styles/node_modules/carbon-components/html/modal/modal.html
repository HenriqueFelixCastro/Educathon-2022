...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-id1s2jq5f5c">Show
  modal</button>

<div data-modal id="modal-id1s2jq5f5c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-id1s2jq5f5c-label" aria-describedby="modal-id1s2jq5f5c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-id1s2jq5f5c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-id1s2jq5f5c-heading">Modal heading</p>
