...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-145722mdpoj">Show
  modal</button>

<div data-modal id="modal-145722mdpoj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-145722mdpoj-label" aria-describedby="modal-145722mdpoj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-145722mdpoj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-145722mdpoj-heading">Modal heading</p>
