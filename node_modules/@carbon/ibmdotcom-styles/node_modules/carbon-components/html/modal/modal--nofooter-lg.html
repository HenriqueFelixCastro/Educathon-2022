...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2o3fhyob1lm">Show
  modal</button>

<div data-modal id="modal-2o3fhyob1lm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2o3fhyob1lm-label" aria-describedby="modal-2o3fhyob1lm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2o3fhyob1lm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2o3fhyob1lm-heading">Modal heading</p>
