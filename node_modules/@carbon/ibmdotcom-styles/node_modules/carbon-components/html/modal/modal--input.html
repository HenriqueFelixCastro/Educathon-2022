...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-07bvs7iqlr94">Show
  modal</button>

<div data-modal id="modal-07bvs7iqlr94" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-07bvs7iqlr94-label" aria-describedby="modal-07bvs7iqlr94-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-07bvs7iqlr94-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-07bvs7iqlr94-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-07bvs7iqlr94" class="bx--label">Text Input label</label>
        <input id="text-input-07bvs7iqlr94" type="text" class="bx--text-input" placeholder="Optional placeholder text"
