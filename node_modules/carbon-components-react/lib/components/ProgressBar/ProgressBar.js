...
function ProgressBar(_ref) {
  ...
  var wrapperClasses = (0, _classnames.default)("".concat(prefix, "--progress-bar"), "".concat(prefix, "--progress-bar--").concat(size), "".concat(prefix, "--progress-bar--").concat(type), (0, _defineProperty2.default)({}, "".concat(prefix, "--progress-bar--indeterminate"), indeterminate), className);
...
ProgressBar.propTypes = {
   ...
   */
  type: _propTypes.default.oneOf(['default', 'inline', 'indented']),
